...
inline void
WuWaGA::Run( std::stop_token StopToken, int GAReportIndex, CharacterConfig Config, const EchoConstraint& Constraints )
{
    ...
    const auto    CommonStats    = Config.GetCombinedStatsWithoutFoundation( );
        ...
        for ( int i = 0, top_count = 0; i < m_PopulationSize; ++i )
        {
            ...
            } else
            {
                ...
                Fitness = Constraints( FinalStat )
                    ? FinalStat.OptimizingValue( Config.CharacterStatsFoundation, BaseFoundation, Resistances, &Config.SkillConfig, &Config.CharacterOverallDeepenStats )
                    : 0;
...
inline void
WuWaGA::Run( const CharacterConfig& Config, const EchoConstraint& Constraints )
{
    m_Threads.clear( );
    ...
    // clang-format off
    m_Threads.emplace_back( std::make_unique<std::jthread>( std::bind(&WuWaGA::Run<ETy, 4, 4, 4, 0, 0>, this, std::placeholders::_1,  0, Config, Constraints ) ) );
    m_Threads.emplace_back( std::make_unique<std::jthread>( std::bind(&WuWaGA::Run<ETy, 4, 4, 3, 1, 0>, this, std::placeholders::_1,  1, Config, Constraints ) ) );
    m_Threads.emplace_back( std::make_unique<std::jthread>( std::bind(&WuWaGA::Run<ETy, 3, 3, 3, 3, 0>, this, std::placeholders::_1,  2, Config, Constraints ) ) );
    m_Threads.emplace_back( std::make_unique<std::jthread>( std::bind(&WuWaGA::Run<ETy, 4, 4, 1, 1, 1>, this, std::placeholders::_1,  3, Config, Constraints ) ) );
    m_Threads.emplace_back( std::make_unique<std::jthread>( std::bind(&WuWaGA::Run<ETy, 4, 1, 1, 1, 1>, this, std::placeholders::_1,  4, Config, Constraints ) ) );
    m_Threads.emplace_back( std::make_unique<std::jthread>( std::bind(&WuWaGA::Run<ETy, 4, 3, 3, 1, 1>, this, std::placeholders::_1,  5, Config, Constraints ) ) );
    m_Threads.emplace_back( std::make_unique<std::jthread>( std::bind(&WuWaGA::Run<ETy, 4, 3, 1, 1, 1>, this, std::placeholders::_1,  6, Config, Constraints ) ) );
    m_Threads.emplace_back( std::make_unique<std::jthread>( std::bind(&WuWaGA::Run<ETy, 3, 1, 1, 1, 1>, this, std::placeholders::_1,  7, Config, Constraints ) ) );
    m_Threads.emplace_back( std::make_unique<std::jthread>( std::bind(&WuWaGA::Run<ETy, 3, 3, 1, 1, 1>, this, std::placeholders::_1,  8, Config, Constraints ) ) );
    m_Threads.emplace_back( std::make_unique<std::jthread>( std::bind(&WuWaGA::Run<ETy, 3, 3, 3, 1, 1>, this, std::placeholders::_1,  9, Config, Constraints ) ) );
    m_Threads.emplace_back( std::make_unique<std::jthread>( std::bind(&WuWaGA::Run<ETy, 1, 1, 1, 1, 1>, this, std::placeholders::_1, 10, Config, Constraints ) ) );
    // clang-format on
}
